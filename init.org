...
- [[#global-options][Global options]]
  ...
  - [[#set-useful-variables][Set useful variables]]
    - [[#init-file][Init file]]
    - [[#basic-user-informations][Basic user informations]]
...
- [[#programming-languages][Programming languages]]
  ...
  - [[#rust][Rust]]
    - [[#cargo][Cargo]]
    - [[#flycheck-for-rust][Flycheck for Rust]]
  - [[#web-modes][Web modes]]
    - [[#main-mode][Main mode]]
    - [[#css-mode][CSS mode]]
...
#+begin_src emacs-lisp
  (use-package doom-modeline
    ...
    (doom-modeline-def-modeline 'mdrp/no-lsp-line
      ...
      '(misc-info persp-name battery grip "git " github " hub" debug minor-modes input-method indent-info buffer-encoding major-mode process vcs checker))
...
** [[https://www.emacswiki.org/emacs/TempoMode][Org tempo]]
:PROPERTIES:
:CUSTOM_ID: org-tempo
:END:

Allows to create easy templates for org.
...
*** [[https://github.com/dryman/toml-mode.el][TOML]]
:PROPERTIES:
:CUSTOM_ID: toml
:END:

This mode will install taplo through cargo if it's not already installed
...
*** [[https://github.com/ayrat555/cargo-mode][Cargo]]
:PROPERTIES:
:CUSTOM_ID: cargo
:END:
...
*** [[https://github.com/flycheck/flycheck-rust][Flycheck for Rust]]
:PROPERTIES:
:CUSTOM_ID: flycheck-for-rust
:END:
